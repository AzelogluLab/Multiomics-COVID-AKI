...
genes1 <- getGeneList("GO:0016477~cell migration")
genes2 <- getGeneList("GO:0048870~cell motility")
genes3 <- getGeneList("GO:0030334~regulation of cell migration")
...
pdf(file = 'scUnique_Healthy_MigrationRelated_supervised_nephronorder_withOrganoids.pdf', height = 13, width = 7)
